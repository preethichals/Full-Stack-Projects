...
function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`https://capstone-proj-82p2.onrender.com/api/v1/auth/login`, {
        email,
        password,
      });
  ...
  return (
    <Layout title={"Register Page"}>
      ...
      >
        <div className="bg-light rounded-3 px-5 pt-5 pb-2">
          <h2
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              <input
                ...
                id="formEmail"
                placeholder="Enter 'admin' as email"
                required
              />
            </div>
            <div className="mb-3">
